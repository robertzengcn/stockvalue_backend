...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "industry", sa.String(100), nullable=False, comment="Industry sector"
        ),
    ...
    op.create_table(
        "rate_data",
        sa.Column(
            "rate_id", sa.String(36), primary_key=True, comment="Unique identifier"
        ),
        sa.Column(
            "rate_date", sa.Date(), nullable=False, unique=True, comment="Date of rate"
        ),
        sa.Column(
            "ten_year_treasury",
            sa.Float(),
