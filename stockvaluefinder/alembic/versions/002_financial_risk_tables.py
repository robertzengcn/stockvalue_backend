...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # Income statement
        sa.Column(
            "revenue", sa.Numeric(20, 2), nullable=False, comment="Total revenue"
        ),
        sa.Column(
            "net_income", sa.Numeric(20, 2), nullable=False, comment="Net profit"
        ),
        sa.Column(
            "operating_cash_flow",
            sa.Numeric(20, 2),
        ...
        # Balance sheet
        sa.Column(
            "assets_total", sa.Numeric(20, 2), nullable=False, comment="Total assets"
        ),
        sa.Column(
            "liabilities_total",
            sa.Numeric(20, 2),
        ...
        sa.Column(
            "equity_total", sa.Numeric(20, 2), nullable=False, comment="Total equity"
        ),
        sa.Column(
            "accounts_receivable",
            sa.Numeric(20, 2),
        ...
        sa.Column(
            "fixed_assets", sa.Numeric(20, 2), nullable=False, comment="Fixed assets"
        ),
        ...
        # Metadata
        sa.Column(
            "report_source", sa.String(100), nullable=False, comment="Source of data"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(),
        ...
        sa.UniqueConstraint(
            "ticker", "period", name="uq_financial_reports_ticker_period"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "report_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("financial_reports.report_id"),
            nullable=False,
            unique=True,
        ...
        # Beneish M-Score
        sa.Column(
            "m_score", sa.Float(), nullable=False, comment="Beneish M-Score value"
        ),
        sa.Column(
            "mscore_data",
            postgresql.JSONB(),
