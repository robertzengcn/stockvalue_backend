...
class ApiResponse(BaseModel, Generic[DataType]):
    ...
    meta: dict[str, object] | None = Field(None, description="Metadata for pagination, etc.")
...
class ApiError(BaseModel):
    ...
    details: dict[str, object] | None = Field(None, description="Additional error context")
